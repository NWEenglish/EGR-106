...
/***********************************************************************
*
*   @variables initialApples The initial starting amount of apples that
*       the user inputs.
*
*   @variables remainingApples The remaining amount of apples that are
*       left over after being bagged.
*
*   @variables wholeBags The number of bags that are produced from the
*       initialApples amount. 12 apples per bag.
*
*   @variables counter Used for controlling the do-while if-else
*       statements. Initialized to 0.
*
***********************************************************************/
...
int main() {
    ...
    /******************************************************************
    *
    *   Loops the program until the user inputs a valid quantity of
    *   apples.
    *
    *******************************************************************/
    do {
